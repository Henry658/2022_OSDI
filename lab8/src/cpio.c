...
void init_cpio(){
	...
	//base_address = (KERNEL_VIRTURE_BASE | (long unsigned int)initramfs_callback());
	base_address = (KERNEL_VIRTURE_BASE | 0x20000000);
	//base_address = (KERNEL_VIRTURE_BASE | 0x8000000);
}
